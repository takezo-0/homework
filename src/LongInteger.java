...
public class LongInteger
{
    ...
    public LongInteger(String longNumber)
    {
        theNumber = new LinkedList<Integer>();

        int aDigit;
        char[] stringArray = longNumber.toCharArray();
        for (int i = 0; i < longNumber.length(); i++) {

            Integer.parseInt(String.valueOf(stringArray[i]));
            theNumber.add(Integer.parseInt(String.valueOf(stringArray[i])));
